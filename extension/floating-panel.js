...
(function() {
    ...
    let backendUrl = 'https://windsurf-backend.vercel.app';
    ...
    function loadSavedData() {
        try {
            ...
            backendUrl = 'https://windsurf-backend.vercel.app';
        ...
        try {
            ...
            const config = await new Promise((resolve) => {
                chrome.storage.sync.get(['backendUrl'], (result) => {
                    resolve(result.backendUrl || 'https://windsurf-backend-feg90yumi-oles-projects-8232c969.vercel.app');
                });
            });
            backendUrl = config;
    ...
    async function startRegistration() {
        try {
            ...
            const config = await new Promise((resolve) => {
                chrome.storage.sync.get(['backendUrl'], (result) => {
                    resolve(result.backendUrl || 'https://windsurf-backend-loqezvjkv-oles-projects-8232c969.vercel.app');
                });
            });
            backendUrl = config;
